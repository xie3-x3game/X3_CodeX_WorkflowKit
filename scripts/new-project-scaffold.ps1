...
$index.Add('3. Review `docs/workflow/rule-update-inbox.md` before changing local workflow rules.')
$index.Add('4. Open the Codex windows listed above.')
$index.Add('5. Use startup commands from `docs/templates/short-window-commands.md`.')
$index.Add('6. Before new substantive work, run dispatch preflight for the active window.')
$index.Add('')
...
$index.Add('- Review `docs/workflow/rule-update-inbox.md` for pending WorkflowKit rule updates.')
...
$charter.Add('- Review `docs/workflow/rule-update-inbox.md` and decide whether WorkflowKit rule updates should be applied, deferred, rejected, or adapted locally.')
$charter.Add('')
...
$windowPlan.Add('')
$windowPlan.Add('## Naming Convention')
$windowPlan.Add('')
$windowPlan.Add('Use mobile-safe names while the client mainly exposes conversation names:')
$windowPlan.Add('')
$windowPlan.Add('- `<Project>｜总控`')
$windowPlan.Add('- `<Project>｜<Window>`')
$windowPlan.Add('- `<Project>｜专项｜<role>｜<topic>`')
$windowPlan.Add('- `<Project>｜临时｜<purpose>`')
$windowPlan.Add('')
...
$sync.Add('- ')
$sync.Add('')
$sync.Add('## Effectiveness Scoring')
$sync.Add('')
$sync.Add('Use `docs/workflow/experience-evaluation.md` when available.')
$sync.Add('')
$sync.Add('| Dimension | Score | Note |')
$sync.Add('| --- | ---: | --- |')
$sync.Add('| EQ Evidence Quality |  |  |')
$sync.Add('| RP Reproducibility |  |  |')
$sync.Add('| OI Outcome Impact |  |  |')
$sync.Add('| TR Transferability |  |  |')
$sync.Add('| RR Risk Reduction |  |  |')
$sync.Add('| LC Low Cost |  |  |')
$sync.Add('| CF Compatibility Fit |  |  |')
$sync.Add('| PR Privacy Risk |  |  |')
$sync.Add('| DR Dirty Data Risk |  |  |')
$sync.Add('| SS Scope Specificity |  |  |')
$sync.Add('| PB Process Burden |  |  |')
$sync.Add('')
$sync.Add('```text')
$sync.Add('Base =')
$sync.Add('Penalty =')
$sync.Add('Confidence =')
$sync.Add('Experience Score =')
$sync.Add('Stage = Raw|Candidate|Validated|Stable|Rejected')
$sync.Add('Reason =')
$sync.Add('```')
$sync.Add('')
